      ...
      <div style={{flex:1,overflowY:"auto",background:"#0e1b2e",display:"flex",flexDirection:"column",minHeight:0}}>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 32px 28px",textAlign:"center"}}>
          ...
          <div style={{display:"flex",gap:12,justifyContent:"center",width:"100%",maxWidth:400}}>
            {[
              {id:"Calm",    emoji:"⚓", label:"Calm Seas",     sub:"Feeling good",  border:"rgba(200,169,122,0.35)", glow:"rgba(200,169,122,0.1)"},
              {id:"Busy",    emoji:"🌊", label:"Some Waves",    sub:"A bit much",    border:"rgba(122,168,200,0.35)", glow:"rgba(122,168,200,0.09)"},
              {id:"Survival",emoji:"🛟", label:"Survival Mode", sub:"Just today",    border:"rgba(200,122,138,0.35)", glow:"rgba(200,122,138,0.09)"},
            ].map(function(m){
