...
function CModal(props) {
  return React.createElement("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.75)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:99999},onClick:props.onClose},
    React.createElement("div",{style:{background:"#1e2e52",border:CAREER_BORD,borderRadius:14,padding:"1.25rem 1.5rem",width:"min(480px,calc(100vw - 2rem))",maxHeight:"85dvh",overflowY:"auto",WebkitOverflowScrolling:"touch"},onClick:function(e){e.stopPropagation();}},
...
function HModal(props) {
  return React.createElement("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.75)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:99999,padding:"env(safe-area-inset-top,1rem) 1rem env(safe-area-inset-bottom,1rem)",overflowY:"auto",WebkitOverflowScrolling:"touch"},onClick:props.onClose},
    React.createElement("div",{style:{background:"#1e2e52",border:HBORD,borderRadius:14,padding:"1.25rem 1.5rem",width:"min(480px,calc(100vw - 2rem))",maxHeight:"calc(100dvh - env(safe-area-inset-top,0px) - env(safe-area-inset-bottom,0px) - 2rem)",overflowY:"auto",WebkitOverflowScrolling:"touch"},onClick:function(e){e.stopPropagation();}},
...
function SubscriptionsSection() {
  ...
  function saveSubs(v) { setSubs(v); save("af_subs", v) }
  function saveCoupons(v) { setCoupons(v); save("af_coupons", v) }
  function savePerks(v) { setPerks(v); save("af_perks", v) }
  ...
  function addSub() {
    if (!form.name) return
    var item = { id: Date.now().toString(), name: form.name, cycle: form.cycle||"monthly", amount: parseFloat(form.amount)||0, website: form.website||"", renewDate: form.renewDate||"", category: form.category||"" }
  ...
  var tabBtn = function(id) { return { background: tab===id ? "rgba(200,169,122,0.15)" : "transparent", border: tab===id ? "0.5px solid rgba(200,169,122,0.35)" : "0.5px solid rgba(255,255,255,0.08)", borderRadius: 20, padding: "5px 14px", color: tab===id ? GOLD : "rgba(250,248,244,0.45)", fontSize: 12, fontFamily: "DM Sans,sans-serif", cursor: "pointer" } }
    ...
    tab === "subs" && React.createElement("div", null,
      subs.length > 0 && React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 14 } },
        ...
        React.createElement("div", { style: { background: "rgba(255,255,255,0.05)", border: "0.5px solid rgba(200,169,122,0.15)", borderRadius: 10, padding: "10px 12px" } },
          ...
          React.createElement("div", { style: { fontSize: 20, fontWeight: 500, color: WHITE, fontFamily: "DM Sans,sans-serif" } }, "$" + yearly.toFixed(2))
        )
      ),
      subs.map(function(s) {
        return React.createElement("div", { key: s.id, style: cardStyle },
          React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" } },
            React.createElement("div", { style: { flex: 1, minWidth: 0 } },
              ...
              React.createElement("div", { style: { fontSize: 11, color: "rgba(250,248,244,0.45)", marginTop: 2, fontFamily: "DM Sans,sans-serif", display: "flex", gap: 8, flexWrap: "wrap" } },
            ...
            React.createElement("div", { style: { textAlign: "right", flexShrink: 0, marginLeft: 12 } },
              ...
              React.createElement("button", { onClick: function() { deleteSub(s.id) }, style: { background: "none", border: "none", color: "rgba(250,248,244,0.25)", cursor: "pointer", fontSize: 12, marginTop: 4, fontFamily: "DM Sans,sans-serif" } }, "remove")
            )
          )
        )
      }),
    ...
    modal && React.createElement("div", { style: modalBg, onClick: function(e) { if (e.target === e.currentTarget) closeModal() } },
      React.createElement("div", { style: modalBox },
        ...
        modal === "sub" && React.createElement("div", null,
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Service name"), React.createElement("input", { style: inp, placeholder: "e.g. Netflix, Spotify", value: form.name||"", onChange: function(e) { setForm(Object.assign({},form,{name:e.target.value})) } })),
          React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 12 } },
          ...
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Website (optional)"), React.createElement("input", { style: inp, placeholder: "e.g. netflix.com", value: form.website||"", onChange: function(e) { setForm(Object.assign({},form,{website:e.target.value})) } })),
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Renewal date (optional)"), React.createElement("input", { style: inp, type: "date", value: form.renewDate||"", onChange: function(e) { setForm(Object.assign({},form,{renewDate:e.target.value})) } }))
        ),
        modal === "coupon" && React.createElement("div", null,
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Name"), React.createElement("input", { style: inp, placeholder: "e.g. Kohl's Cash, Target Circle", value: form.name||"", onChange: function(e) { setForm(Object.assign({},form,{name:e.target.value})) } })),
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Amount or value"), React.createElement("input", { style: inp, placeholder: "e.g. $30 or 20% off", value: form.amount||"", onChange: function(e) { setForm(Object.assign({},form,{amount:e.target.value})) } })),
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Use by date"), React.createElement("input", { style: inp, type: "date", value: form.expires||"", onChange: function(e) { setForm(Object.assign({},form,{expires:e.target.value})) } })),
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Notes (optional)"), React.createElement("input", { style: inp, placeholder: "e.g. in-store or online, app required", value: form.notes||"", onChange: function(e) { setForm(Object.assign({},form,{notes:e.target.value})) } }))
        ),
        modal === "perk" && React.createElement("div", null,
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Type"),
          ...
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Where / Name"), React.createElement("input", { style: inp, placeholder: "e.g. Chick-fil-A, Home Depot", value: form.name||"", onChange: function(e) { setForm(Object.assign({},form,{name:e.target.value})) } })),
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Details"), React.createElement("input", { style: inp, placeholder: "e.g. Tuesdays, ages 12 & under, 10% off", value: form.detail||"", onChange: function(e) { setForm(Object.assign({},form,{detail:e.target.value})) } })),
          React.createElement("div", { style: row }, React.createElement("label", { style: lbl }, "Notes (optional)"), React.createElement("input", { style: inp, placeholder: "e.g. ID required, app required", value: form.notes||"", onChange: function(e) { setForm(Object.assign({},form,{notes:e.target.value})) } }))
        ),
        React.createElement("div", { style: { display: "flex", gap: 8, marginTop: 8 } },
          ...
          React.createElement("button", {
            onClick: modal === "sub" ? addSub : modal === "coupon" ? addCoupon : addPerk,
            style: { flex: 1, background: GOLD, border: "none", borderRadius: 10, padding: "10px", color: NAVY, fontFamily: "DM Sans,sans-serif", fontSize: 14, fontWeight: 700, cursor: "pointer" }
          }, "Save")
        )
      )
    )
...
// ── Ripples Section (kid milestones & memories) ───────────────────────────────
var RIPPLE_CATS = [
  { id: "all",        label: "All" },
...
function RipplesSection() {
  ...
  function closeModal() { setModal(false); setForm({ name: "", who: "", category: "milestone", date: "", note: "" }); setEditId(null) }

  function submit() {
    if (!form.name.trim()) return
    if (editId) {
      save(ripples.map(function(r) { return r.id === editId ? Object.assign({}, r, form) : r }))
    } else {
      save([...ripples, Object.assign({ id: Date.now().toString() }, form)])
    }
    closeModal()
  }
  ...
  return React.createElement("div", { style: { paddingBottom: "2rem" } },
    ...
    React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 16 } },
      RIPPLE_CATS.map(function(c) {
        ...
        return React.createElement("button", {
          ...
          style: { background: active ? "rgba(200,169,122,0.15)" : "transparent", border: active ? "0.5px solid rgba(200,169,122,0.35)" : "0.5px solid rgba(255,255,255,0.08)", borderRadius: 20, padding: "4px 12px", color: active ? GOLD : "rgba(250,248,244,0.45)", fontSize: 11, fontFamily: "DM Sans,sans-serif", cursor: "pointer" }
        }, c.label)
      })
    ),
    ...
    modal && React.createElement("div", { style: modalBg, onClick: function(e) { if (e.target === e.currentTarget) closeModal() } },
      React.createElement("div", { style: modalBox },
        ...
        React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 12 } },
          React.createElement("div", null, React.createElement("label", { style: lbl }, "Who"),
            React.createElement("input", { style: inp, placeholder: "e.g. Eli, Clara", value: form.who, onChange: function(e) { setForm(Object.assign({},form,{who:e.target.value})) } })
          ),
          React.createElement("div", null, React.createElement("label", { style: lbl }, "Date"),
            React.createElement("input", { style: inp, type: "date", value: form.date, onChange: function(e) { setForm(Object.assign({},form,{date:e.target.value})) } })
          )
        ),
