...
var H_REL_ROLES = [
  "Maternal grandmother","Maternal grandfather","Mother","Maternal aunt","Maternal uncle",
  "Paternal grandmother","Paternal grandfather","Father","Paternal aunt","Paternal uncle",
  "Sibling","Other",
]
var H_COND_TYPES = [
...
function HBadge(props) {
  var b=HBADGE[props.type]||HBADGE.gray;
  return React.createElement("span",{style:{fontSize:11,padding:"2px 8px",borderRadius:12,whiteSpace:"nowrap",background:b.bg,color:b.color,border:"0.5px solid "+b.border}},props.label);
}
function HCondPill(props) {
  var p=HPILL[props.type]||HPILL.other;
  return React.createElement("span",{style:{fontSize:11,padding:"2px 9px",borderRadius:12,background:p.bg,color:p.color,border:"0.5px solid "+p.border}},props.label);
}
function HCard(props) {
  return React.createElement("div",{style:Object.assign({background:HSURF,border:HBORD,borderRadius:10,padding:"0.9rem 1.1rem"},props.style||{})},props.children);
}
function HCardHead(props) {
  return React.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"0.7rem"}},
    React.createElement("span",{style:{fontSize:13,fontWeight:500,color:"rgba(250,248,244,0.7)",display:"flex",alignItems:"center",gap:6}},
      React.createElement("span",{style:{fontSize:15,color:HGOLD}},props.icon),props.label),
...
function HItemRow(props) {
  return React.createElement("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"space-between",padding:"0.45rem 0",borderBottom:HBORD2,gap:8}},
    React.createElement("div",{style:{flex:1}},
      React.createElement("p",{style:{fontSize:13,color:HWHITE,fontWeight:500,margin:"0 0 2px"}},props.name),
      props.detail&&React.createElement("p",{style:{fontSize:12,color:"rgba(250,248,244,0.4)",margin:0}},props.detail)
    ),
  ...
  return React.createElement("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.7)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:9999},onClick:props.onClose},
    React.createElement("div",{style:{background:"#1e2e52",border:HBORD,borderRadius:14,padding:"1.25rem 1.5rem",width:"min(480px,92vw)",maxHeight:"85vh",overflowY:"auto"},onClick:function(e){e.stopPropagation();}},
      React.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"1rem"}},
        React.createElement("span",{style:{color:HWHITE,fontSize:15,fontWeight:500}},props.title),
...
export default function AnchorVault({ onClose, calEvents = [], vaultSection = "home" }) {
  const [activeSection, setActiveSection] = useState(vaultSection)
  React.useEffect(function() { setActiveSection(vaultSection) }, [vaultSection])
    ...
    <div style={{ position: "fixed", top: 0, left: 68, right: 0, bottom: 0, zIndex: 150, display: "flex" }}>
      ...
      <div style={{ flex: 1, background: "#1e2e50", overflowY: "auto", padding: "24px 20px" }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          {["career","subs"].includes(activeSection) && (
