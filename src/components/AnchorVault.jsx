...
function CelebrationsSection({ calEvents, onOpenRecipe, onBrowseRecipes }) {
  ...
  const MODAL_INP = { background: "rgba(255,255,255,0.12)", border: "1px solid rgba(250,248,244,0.25)", borderRadius: 8, padding: "8px 12px", fontSize: 13, color: "#faf8f4", WebkitTextFillColor: "#faf8f4", caretColor: "#c8a97a", fontFamily: "DM Sans,sans-serif", outline: "none", boxSizing: "border-box" }
...
var C_INP_STYLE = {width:"100%",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.5rem 0.7rem",color:CAREER_MODAL_TEXT,WebkitTextFillColor:CAREER_MODAL_TEXT,caretColor:CAREER_GOLD,fontSize:13,fontFamily:"inherit",outline:"none",boxSizing:"border-box"}
...
function CSelect(props) {
  return React.createElement("div",{style:{marginBottom:"0.7rem"}},
    props.label&&React.createElement("label",{style:{display:"block",fontSize:11,color:"rgba(250,248,244,0.4)",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:4}},props.label),
    React.createElement("select",{value:props.value,onChange:function(e){props.onChange(e.target.value);},style:{width:"100%",WebkitAppearance:"none",appearance:"none",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.5rem 0.7rem",color:CAREER_MODAL_TEXT,fontSize:13,fontFamily:"inherit",outline:"none",boxSizing:"border-box"}},
          ...
          React.createElement(CCard,null,list.map(function(job){
            return React.createElement("div",{key:job.id,style:{display:"flex",alignItems:"flex-start",gap:10,padding:"0.5rem 0",borderBottom:CAREER_BORD2}},
              ...
              React.createElement("div",{style:{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:4,flexShrink:0}},
                React.createElement("select",{value:job.status,onChange:function(e){updateStatus(job.id,e.target.value);},style:{fontSize:11,WebkitAppearance:"none",appearance:"none",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:6,padding:"2px 6px",color:STATUS_COLORS[job.status]||CAREER_GOLD,fontFamily:"inherit",cursor:"pointer"}},JOB_STATUSES.map(function(s){return React.createElement("option",{key:s,value:s},s)})),
            ...
            active.map(function(g){
              ...
              return React.createElement("div",{key:g.id,style:{background:CAREER_SURF,border:CAREER_BORD,borderRadius:8,overflow:"hidden"}},
                      ...
                      ? React.createElement("div",{style:{marginTop:7,background:"rgba(26,46,61,0.05)",borderRadius:8,padding:"9px"}},
                          ...
                          React.createElement("div",{style:{display:"flex",gap:7,marginBottom:7}},
                            ...
                            React.createElement("div",{style:{flex:1}},
                              ...
                              React.createElement("select",{value:stepForm.sendTo,onChange:function(e){setStepForm(function(f){return Object.assign({},f,{sendTo:e.target.value});});},style:Object.assign({},C_INP_STYLE,{WebkitAppearance:"none",appearance:"none"})},
                ...
                isEditing&&React.createElement("div",{style:{padding:"12px"}},
                  ...
                  React.createElement("select",{value:editForm.area,onChange:function(e){setEditForm(function(f){return Object.assign({},f,{area:e.target.value});});},style:Object.assign({},C_INP_STYLE,{marginBottom:8,WebkitAppearance:"none",appearance:"none"})},
...
function HInput(props) {
  return React.createElement("div",{style:{marginBottom:"0.75rem"}},
    props.label&&React.createElement("label",{style:{display:"block",fontSize:11,color:"rgba(250,248,244,0.4)",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:4}},props.label),
    React.createElement("input",{type:props.type||"text",value:props.value,onChange:function(e){props.onChange(e.target.value);},placeholder:props.placeholder,style:{width:"100%",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.55rem 0.75rem",color:HMODAL_TEXT,fontSize:13,fontFamily:"inherit",outline:"none",boxSizing:"border-box"}})
  );
}
function HTextarea(props) {
  return React.createElement("div",{style:{marginBottom:"0.75rem"}},
    props.label&&React.createElement("label",{style:{display:"block",fontSize:11,color:"rgba(250,248,244,0.4)",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:4}},props.label),
    React.createElement("textarea",{value:props.value,onChange:function(e){props.onChange(e.target.value);},placeholder:props.placeholder,rows:props.rows||4,style:{width:"100%",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.55rem 0.75rem",color:HMODAL_TEXT,fontSize:13,fontFamily:"inherit",outline:"none",resize:"vertical",boxSizing:"border-box"}})
  );
}
function HSelect(props) {
  return React.createElement("div",{style:{marginBottom:"0.75rem"}},
    ...
    React.createElement("select",{value:props.value,onChange:function(e){props.onChange(e.target.value);},style:{width:"100%",WebkitAppearance:"none",appearance:"none",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.55rem 0.75rem",color:HMODAL_TEXT,fontSize:13,fontFamily:"inherit",outline:"none",boxSizing:"border-box"}},
      props.options.map(function(o){return React.createElement("option",{key:o.value,value:o.value},o.label);})    )
  );
}
...
function HTimePicker(props) {
  ...
  var selStyle={WebkitAppearance:"none",appearance:"none",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:7,padding:"0.48rem 0.4rem",color:HMODAL_TEXT,fontSize:13,fontFamily:"inherit",outline:"none",cursor:"pointer"};
  ...
  return React.createElement(React.Fragment,null,
    ...
    open&&React.createElement(HModal,{title:"Add family member",onClose:function(){setOpen(false);}},
      ...
      React.createElement("div",{style:{marginBottom:"0.75rem"}},
        ...
        React.createElement("div",{style:{display:"flex",gap:6}},
          React.createElement("select",{value:condIn.type,onChange:function(e){setCondIn(function(c){return Object.assign({},c,{type:e.target.value});});},style:{WebkitAppearance:"none",appearance:"none",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.4rem 0.5rem",color:HMODAL_TEXT,fontSize:12,fontFamily:"inherit",outline:"none",flexShrink:0}},H_COND_TYPES.map(function(c){return React.createElement("option",{key:c.id,value:c.id},c.label);})),
          React.createElement("input",{value:condIn.label,onChange:function(e){setCondIn(function(c){return Object.assign({},c,{label:e.target.value});});},placeholder:"Condition name",style:{flex:1,background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.4rem 0.6rem",color:HMODAL_TEXT,fontSize:12,fontFamily:"inherit",outline:"none"}}),
...
function HouseFileSection() {
  ...
  return React.createElement("div",null,
    ...
    React.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}},
      React.createElement("div",{style:{fontFamily:"Cormorant Garamond,serif",fontSize:22,fontWeight:600,color:"#faf8f4"}},"House Files"),
      ...
      cardType==="note"&&React.createElement("div",null,
        cardFields.map(function(f,i){
          return React.createElement("div",{key:i,style:{marginBottom:8}},
            ...
            React.createElement("input",{value:f.value,onChange:function(e){var v=e.target.value;setCardFields(function(prev){return prev.map(function(ff,ii){return ii===i?Object.assign({},ff,{value:v}):ff;});});},style:{width:"100%",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.5rem 0.7rem",color:"#faf8f4",fontSize:13,fontFamily:"DM Sans,sans-serif",outline:"none",boxSizing:"border-box"}})
          );
        }),
        // add custom field
        fieldEdit!==null
          ? React.createElement("div",{style:{display:"flex",gap:6,marginTop:6}},
              React.createElement("input",{value:fieldEdit,onChange:function(e){setFieldEdit(e.target.value);},placeholder:"Field label",autoFocus:true,style:{flex:1,background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.45rem 0.65rem",color:"#faf8f4",fontSize:12,fontFamily:"DM Sans,sans-serif",outline:"none"}}),
      ...
      cardType==="checklist"&&React.createElement("div",null,
        ...
        cardItems.map(function(item,i){
          return React.createElement("div",{key:item.id,style:{display:"flex",alignItems:"center",gap:6,marginBottom:4}},
            React.createElement("input",{value:item.text,onChange:function(e){var v=e.target.value;setCardItems(function(prev){return prev.map(function(it,ii){return ii===i?Object.assign({},it,{text:v}):it;});});},style:{flex:1,background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.4rem 0.65rem",color:"#faf8f4",fontSize:12,fontFamily:"DM Sans,sans-serif",outline:"none"}}),
        ...
        React.createElement("div",{style:{display:"flex",gap:6,marginTop:4}},
          React.createElement("input",{value:newItem,onChange:function(e){setNewItem(e.target.value);},onKeyDown:function(e){if(e.key==="Enter"){addChecklistItem();}},placeholder:"Add item…",style:{flex:1,background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.4rem 0.65rem",color:"#faf8f4",fontSize:12,fontFamily:"DM Sans,sans-serif",outline:"none"}}),
...
function HomeSection() {
  ...
  return React.createElement("div",null,
    ...
    React.createElement("div",{style:{display:"flex",gap:0,borderBottom:HBORD,marginBottom:20}},
      ...
      React.createElement("button",{onClick:function(){setHomeTab("file");},style:{padding:"8px 18px",fontSize:13,background:"none",border:"none",borderBottom:homeTab==="file"?"2px solid "+HGOLD:"2px solid transparent",color:homeTab==="file"?HGOLD:"rgba(250,248,244,0.4)",cursor:"pointer",fontFamily:"DM Sans,sans-serif",fontWeight:homeTab==="file"?600:400}},"📁 House Files")
    ),
...
function ProductsPanel() {
  ...
  var SURF="#f7f1e3";
  var inp={width:"100%",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"9px 11px",color:"#faf8f4",fontSize:13,fontFamily:"DM Sans,sans-serif",outline:"none",boxSizing:"border-box"};
  ...
  return React.createElement("div",null,
    ...
    adding&&React.createElement(HModal,{title:editIdx!==null?"Edit system":"Add system",onClose:function(){setAdding(false);setEditIdx(null);}},
      ...
      React.createElement("div",{style:{marginBottom:"0.75rem"}},
        ...
        React.createElement("select",{value:form.freq,onChange:function(e){setForm(function(f){return Object.assign({},f,{freq:e.target.value});});},style:{width:"100%",WebkitAppearance:"none",appearance:"none",background:"rgba(255,255,255,0.12)",border:"1px solid rgba(250,248,244,0.25)",borderRadius:8,padding:"0.5rem 0.7rem",color:"#faf8f4",fontSize:13,fontFamily:"DM Sans,sans-serif",outline:"none"}},
...
function SubscriptionsSection() {
  ...
  var inp = { WebkitAppearance: "none", appearance: "none", background: "rgba(255,255,255,0.12)", border: "1px solid rgba(250,248,244,0.25)", borderRadius: 8, padding: "9px 12px", color: WHITE, fontFamily: "DM Sans,sans-serif", fontSize: 13, width: "100%", outline: "none" }
